        ...
        >
          <div className="w-full flex flex-col gap-14">
            ...
            <div className="text-nice-gray dark:text-alt-gray font-urban tracking-[0.18px] md:text-lg w-[96%]">
              A talented frontend and product designer with years of experience
          ...
          <footer className="flex justify-between w-full my-16 lg:mb-0">
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hidden sm:inline text-xs font-semibold cursor-pointer font-urban dark:text-whitey text-darko transition-all transform duration-75 ease-out"
              >
                Coded by Walediwura
              </a>
            </motion.section>
